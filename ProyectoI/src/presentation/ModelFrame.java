...
public class ModelFrame extends JFrame {
	...
	public void setJTableAirplaneModels(DefaultTableModel dtmTAirplaneModels) {
		...
		jTableAirplaneModels.getTableHeader().setBackground(new Color(28, 28, 28));
	...
	public JButton getBReturn() {
		if (bReturn == null) {
			bReturn = new JButton("");
			bReturn.setIcon(new ImageIcon(ModelFrame.class.getResource("/imagesMain/imagesButtons/return.png")));
