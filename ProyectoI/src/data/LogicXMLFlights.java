...
public class LogicXMLFlights {
	...
	private boolean isValidFlightElement(Element element) {
		return element.getElementsByTagName("FlightNumber").getLength() > 0
				&& element.getElementsByTagName("DepartureCity").getLength() > 0
				&& element.getElementsByTagName("DepartureDate").getLength() > 0
				&& element.getElementsByTagName("DepartureTime").getLength() > 0
				&& element.getElementsByTagName("ArrivalCity").getLength() > 0
				&& element.getElementsByTagName("ArrivalDate").getLength() > 0
				&& element.getElementsByTagName("ArrivalTime").getLength() > 0
				&& element.getElementsByTagName("Airplane").getLength() > 0
				&& element.getElementsByTagName("BusinessClassSeatsPrice").getLength() > 0
				&& element.getElementsByTagName("TouristClassSeatsPrice").getLength() > 0
				&& element.getElementsByTagName("EconomyClassSeatsPrice").getLength() > 0;
	}
}